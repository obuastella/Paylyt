                ...
                <div className="relative bg-[#1a1a1a] rounded-[3rem] p-3 shadow-2xl border border-white/5">
                  <div className="bg-[#0f0f0f] rounded-[2.5rem] overflow-hidden">
                    ...
                    <div className="px-6 py-6">
                      {/* Header */}
                      <div className="flex items-center justify-between mb-6">
                        <h2 className="text-2xl font-bold">Paylyt</h2>
                      ...
                      <div className="bg-gradient-to-br from-[#9b8aff] to-[#7c6aef] rounded-2xl p-5 mb-6 shadow-lg">
                        ...
                        <div className="mb-3">
                          ...
                          <p className="text-xs text-white/80">
                            80% of ₹22,000 Budget Used
                          </p>
                        </div>
                        <button className="text-xs text-white/90 underline">
                          View Full Report
                        </button>
                      </div>
                  ...
                  <div className="bg-[#0f0f0f] rounded-[2.5rem] overflow-hidden">
                    ...
                    <div className="px-6 py-6">
                      ...
                      <div className="flex gap-2 mb-6 flex-wrap">
                        <button className="px-3 py-1.5 rounded-full bg-[#7c6aef] text-xs font-medium">
                          Day
                        </button>
                        <button className="px-3 py-1.5 rounded-full bg-white/5 text-xs font-medium hover:bg-white/10 transition-colors">
                          Week
                        </button>
                        <button className="px-3 py-1.5 rounded-full bg-white/5 text-xs font-medium hover:bg-white/10 transition-colors">
                          Month
