    ...
    <>
      <div className="bg-[#1a1a1a] rounded-3xl p-6 border border-white/5 hover:border-white/10 transition-all">
        ...
        <div className="relative group cursor-pointer">
          ...
          <div className="relative rounded-2xl p-6 overflow-hidden bg-gradient-to-br  ">
            ...
            <div className="relative">
              ...
              <div className="flex items-center justify-between">
                ...
                <button className="w-10 h-10 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white/30 transition-colors group">
                  <ArrowRight
                    size={18}
          ...
          <div className="bg-[#1a1a1a] rounded-2xl p-6 w-full max-w-md border border-white/10">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 py-3 px-4 bg-[#C57CF9] hover:bg-[#C57CF9]/600 disabled:bg-white/5 disabled:text-white/40 rounded-xl transition-colors font-medium"
              >
                Add Funds
              </button>
            </div>
          ...
          <div className="bg-[#1a1a1a] rounded-2xl p-6 w-full max-w-md border border-white/10">
            ...
            <div className="flex gap-3">
              ...
              <button
                ...
                className="flex-1 py-3 px-4 bg-blue-500 hover:bg-blue-600 disabled:bg-white/5 disabled:text-white/40 rounded-xl transition-colors font-medium"
              >
                Update Balance
              </button>
            </div>
